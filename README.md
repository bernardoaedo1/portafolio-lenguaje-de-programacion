...
Repositorio de la asignatura \*\*Lenguaje de Programación\*\*. Este portafolio contiene sowftare académico en \*\*Python\*\* para uso didácto en ingeniería.
...
\* \*\*Ubicación:\*\* `/calculadora/Baedo\_t1.py`
...
\* \*\*Ubicación:\*\* `/calendario\_turnos/Baedo\_t2.py`
...
\* \*\*Ubicación:\*\* `/analisis\_poblacion/Baedo\_t3.ipynb`
...
\* \*\*Ubicación:\*\* `/algoritmo\_genetico/Baedo\_t4.ipynb`
...
\### En el Gráfico de Población (`Baedo\_t3.ipynb`):
...
&nbsp;   \* \*Solución:\* Usar `self.poblacion\_regional()` internamente.



\### En el Calendario de Turnos (`Baedo\_t2.py`):
...
\### En la Calculadora (`Baedo\_t1.py`):
